"""Backup only: new verifier C delta; restore in a fresh bare repository. No project execution."""
...
SOURCE=Path('/Users/elinhaggstrom/nortropic-repos/work/test-author-h039-verifier-P005366dd-20260912')
C='83f75968b9892ae98a6a879178c407d2a6fd935e'
P='005366dd5e3a9a74d8140c9dd0c0175aea268294'
TREE='8da632c48be1705d536be39bb2afc3b4b2d70f51'
REF='refs/heads/nortropic/loop-h039-verifier-local-20260912'
BUNDLE=BASE/'bundles/h039-verifier-C-83f75968-incremental.bundle'
DOWNLOAD=HERE/'h039-verifier-C-83f75968-incremental.download.bundle'
INSPECTION=HERE/'h039-verifier-C-83f75968-bundle-inspection.json'
RESTORE=HERE/'h039-verifier-C-83f75968-bundle-restore.json'
...
if sys.argv[1]=='prepare':
 ...
 check();root=Path(tempfile.mkdtemp(prefix='nortropic-h039-verifier-C-restore-',dir='/private/tmp'))
 ...
 git(root,'update-ref','refs/heads/restored-verifier-C',C,'0'*40)
 git(root,'symbolic-ref','HEAD','refs/heads/restored-verifier-C')
