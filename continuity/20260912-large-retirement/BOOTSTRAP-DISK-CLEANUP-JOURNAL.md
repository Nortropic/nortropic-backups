...
## 2026-09-12T17:33Z — two large raw representations retired; disk margin restored

The exact two scratchpad-refresh tar backups dated20260910T195603Z and
20260910T202553Z under full-20260910T103342Z/external were removed by
`/opt/homebrew/bin/python3.12 -I -S -B retire_two_large_raw_representations.py`,
exit0. Script SHA25608408a4a5a755e82b6e03b0296613a292c1014276e39ecc010b569c60c2056bd.
Scope follows the direct user continuation, documented as an agent-selected
bounded representation change in LARGE-RAW-REPRESENTATION-RETIREMENT.md,
SHA256e3f5ad6db9e2142bc55b671b39add2e5d02281e670b9f655dc040e24035f298e.
The earlier eight-file authorization is not used as a blanket rule.

Fresh checks compared both complete retained local gzip decodings byte-for-byte
against raw sources and rechecked all45 GitHub assets in private repo1367371291.
Remote readback session49613 finished exit0, receipt
large-external-concurrent-verify-r2-receipt.json SHA256
b2ed8f45ece68ded7d47afc958664b42aa638db9b096676e442e209b56adfd01.
Both complete raw archive hashes/lengths matched; all45 parts exit0/empty stderr.
Fresh no-open-file checks and exact retained source/name identities preceded
descriptor-relative single-file unlink/fsync. No recursive deletion, repository,
worktree, original scratchpad, held source, manifest or unique evidence removal.
Both local gzip files and all45 remote raw segments remain; exact reconstruction
instructions are in README-CURRENT-RECOVERY.md. No Trash copies were created.

Transfer directory: github-history-transfer-20260912.HYawFS next to the backupbase.
Preflight SHA25656ad50942381ac8753a837733676a3122951b3fc6b17f77a868803670aad7f85;
execution29628bf5376a65d5af9844376412c6542f24fa2a3f262d537b3948ce10c79799;
result5ec0a90c549c1211054347359cf60ccec4f0148a453c03e9ed07debf443f2e6d.
Logical removed5,846,117,376B; retained gzip2,978,557,677B. Immediate observed
free delta2,573,602,816B; later df23,709,412KiB (~22.61GiB). Do not substitute
logical file sizes for a fresh disk check. The H03920GiB build floor and its
additional per-run margin remain unchanged. Platform status remains clean8095d947.
Full new remote base+delta filesystem restoration and withheld H036 capability
log custody remain separate coverage gaps; no bootstrap/runtime credit follows.
